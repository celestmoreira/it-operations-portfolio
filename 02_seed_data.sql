...
-- Run AFTER 01_schema.sql. Gives the queries something to chew on.
-- All people/companies here are fictional. Do NOT use real coworkers.
-- =====================================================================
...
-- Employees -----------------------------------------------------------
-- (department_id / location_id refer to the rows inserted above)
...
-- Assets --------------------------------------------------------------
-- Mix of assigned, in stock, in repair, retired. Mix of warranty dates
-- so the "expiring soon" and "expired" reports actually have hits.
INSERT INTO assets
...
-- Assignment history --------------------------------------------------
-- Note: the retired Lenovo (asset_id 10) was previously held by Alex Kim
-- (now terminated) and returned — shows the offboarding side.
